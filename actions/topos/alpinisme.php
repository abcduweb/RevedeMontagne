...
$intro = parse_var(get_file(TPL_ROOT.'zCode_topo/alpinisme.tpl'),array('orientation'=>$orientation,
...
'glacier'=>$glacier,'cot-glob'=>$cotation_globale,'qt-equipement'=>$qualite_equipement,
