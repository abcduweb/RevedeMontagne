...
<div class="arbre">Vous &#234;tes ici : 
	...
	<a href="liste-des-topos-de-randonnee.html">liste des topos de randonnée</a> &gt;  
	<a href="#">{massif}</a> &gt;  
	<a href="#">{sommet}</a> &gt;  
	Editer du topo
</div>
...
<div class="cadre">	
	...
	<div class="cadre_1_cg">
		...
		<br />
			<!--- D�but du formulaire--->
			<form enctype="multipart/form-data" action="{DOMAINE}/topos/envoi_topo_rando.php?s={s}{edition}" method="post">	
