...
<div class="arbre">
	...
	<a href="liste-des-refuges.html">liste refuges</a> &gt;
			...
			<table>
				...
				<tbody>
					...
					<tr class="ligne{ligne}">
						<td class="col_titre"><a href="detail-{listerefuge.nom_refuge_url}-{listerefuge.id_point}-1.html">{listerefuge.nom_refuge}</a></td>
						<td>{listerefuge.altitude} m</td>
