	...
	jQuery.fn.easyShare = function(options) {
		...
		sites = {
			'bebo': {
				...
				icone: './../templates/images/1/share/bebo_16.png',
				icone_big: './../templates/images/1/share/bebo_32.png'
			},
			'bitly': {
				name: 'bit.ly',
				target: 'http://bit.ly/?url={url}',
				icone: './../templates/images/1/share/bitly_16.png',
				icone_big: ''
			},
			'delicious': {
				name: 'del.icio.us',
				target: 'http://del.icio.us/post?url={url}&amp;title={title}',
				icone: './../templates/images/1/share/delicious_16.png',
				icone_big: './../templates/images/1/share/delicious_32.png'
			},			
			'digg': {
				name: 'Digg',
				target: 'http://digg.com/submit?phase=2&amp;url={url}&amp;title={title}',
				icone: './../templates/images/1/share/digg_16.png',
				icone_big: './../templates/images/1/share/digg_32.png'
			},
			'dzone': {
				name: 'DZone',
				target: 'http://www.dzone.com/links/add.html?url={url}&amp;title={title}',
				icone: './../templates/images/1/share/dzone_16.png',
				icone_big: './../templates/images/1/share/dzone_32.png'
			},
			'email': {
				name: 'E-mail',
				target: 'mailto:?subject={title}&body={url}',				
				icone: './../templates/images/1/share/email_16.png',
				icone_big: './../templates/images/1/share/email_32.png'
			},
			'evernote': {
				name: 'Evernote',
				target: 'http://www.evernote.com/clip.action?url={url}&amp;title={title}',
				icone: './../templates/images/1/share/evernote_16.png',
				icone_big: './../templates/images/1/share/evernote_32.png'
			},
			'facebook': {
				name: 'Facebook',
				target: 'http://www.facebook.com/sharer.php?u={url}&amp;t={title}',				
				icone: './../templates/images/1/share/facebook_16.png',
				icone_big: './../templates/images/1/share/facebook_32.png'
			},
			'favoris': {
				name: 'Favoris',
				target: '',				
				icone: './../templates/images/1/share/bookmarks_16.png',
				icone_big: './../templates/images/1/share/bookmarks_32.png'
			},
			'friendfeed': {
				name: 'FriendFeed',
				target: 'http://friendfeed.com/share?url={url}&amp;title={title}',
				icone: './../templates/images/1/share/friendfeed_16.png',
				icone_big: './../templates/images/1/share/friendfeed_32.png'
			},
			'google': {
				name: 'Google',
				target: 'http://www.google.com/bookmarks/mark?op=edit&amp;bkmk={url}&amp;title={title}',				
				icone: './../templates/images/1/share/google_16.png',
				icone_big: './../templates/images/1/share/google_32.png'
			},
			'linkedin': {
				name: 'LinkedIn',
				target: 'http://www.linkedin.com/shareArticle?mini=true&amp;url={url}&amp;title={title}&amp;ro=false&amp;summary=&amp;source=',
				icone: './../templates/images/1/share/linkedin_16.png',
				icone_big: './../templates/images/1/share/linkedin_32.png'
			},
			'live': {
				name: 'Live',
				target: 'https://skydrive.live.com/sharefavorite.aspx/.SharedFavorites?url={url}&amp;title={title}',				
				icone: './../templates/images/1/share/live_16.png',
				icone_big: './../templates/images/1/share/live_32.png'
			},
			'myspace': {
				name: 'MySpace',
				target: 'http://www.myspace.com/Modules/PostTo/Pages/?c={url}&amp;t={title}',				
				icone: './../templates/images/1/share/myspace_16.png',
				icone_big: './../templates/images/1/share/myspace_32.png'
			},
			'netvibes': {
				name: 'Netvibes',
				target: 'http://www.netvibes.com/share?url={url}&amp;title={title}',
				icone: './../templates/images/1/share/netvibes_16.png',
				icone_big: './../templates/images/1/share/netvibes_32.png'
			},
			'ping': {
				name: 'Ping',
				target: 'http://ping.fm/ref/?link={url}&amp;title={title}',
				icone: './../templates/images/1/share/ping_16.png',
				icone_big: ''
			},
			'reddit': {
				name: 'reddit',
				target: 'http://reddit.com/submit?url={url}&amp;title={title}',
				icone: './../templates/images/1/share/reddit_16.png',
				icone_big: './../templates/images/1/share/reddit_32.png'
			},
			'scoopeo': {
				name: 'Scoopeo',
				target: 'http://www.scoopeo.com/scoop/new?newurl={url}&amp;title={title}',				
				icone: './../templates/images/1/share/scoopeo_16.png',
				icone_big: './../templates/images/1/share/scoopeo_32.png'
			},
			'slashdot': {
				name: 'Slashdot',
				target: 'http://slashdot.org/bookmark.pl?url={url}&amp;title={title}',
				icone: './../templates/images/1/share/slashdot_16.png',
				icone_big: './../templates/images/1/share/slashdot_32.png'
			},
			'stumbleupon': {
				name: 'StumbleUpon',
				target: 'http://www.stumbleupon.com/submit?url={url}&amp;title={title}',
				icone: './../templates/images/1/share/stumbleupon_16.png',
				icone_big: './../templates/images/1/share/stumbleupon_32.png'
			},
			'technorati': {
				name: 'Technorati',
				target: 'http://www.technorati.com/faves?add={url}',
				icone: './../templates/images/1/share/technorati_16.png',
				icone_big: './../templates/images/1/share/technorati_32.png'
			},
			'twitter': {
				name: 'Twitter',
				target: 'http://twitter.com/home?status={url}+via+{title}',				
				icone: './../templates/images/1/share/twitter2_16.png',
				icone_big: './../templates/images/1/share/twitter_32.png'
			},			
			'yahoo': {
				name: 'Yahoo!',
				target: 'http://bookmarks.yahoo.com/myresults/bookmarklet?u={url}&amp;t={title}',				
				icone: './../templates/images/1/share/yahoo_16.png',
				icone_big: './../templates/images/1/share/yahoo_32.png'
			},
			'yahoobuzz': {
				name: 'Yahoo Buzz',
				target: 'http://buzz.yahoo.com/submit?submitUrl={url}&amp;submitHeadline={title}',
				icone: './../templates/images/1/share/yahoobuzz_16.png',
				icone_big: './../templates/images/1/share/yahoobuzz_32.png'
			}
		};
